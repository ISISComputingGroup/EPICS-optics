...
dbLoadDatabase "../../dbd/opticsTest.dbd"
opticsTest_registerRecordDeviceDriver pdbbase


### Slits
dbLoadRecords("$(OPTICS)/opticsApp/Db/2slit.db","P=$(MYPVPREFIX),SLIT=Slit1V,mXp=m3,mXn=m4")
dbLoadRecords("$(OPTICS)/opticsApp/Db/2slit.db","P=$(MYPVPREFIX),SLIT=Slit1H,mXp=m5,mXn=m6")
#dbLoadRecords("$(OPTICS)/opticsApp/Db/2slit_soft.db","P=$(MYPVPREFIX),SLIT=Slit1V,mXp=m3,mXn=m4")
#dbLoadRecords("$(OPTICS)/opticsApp/Db/2slit_soft.db","P=$(MYPVPREFIX),SLIT=Slit1H,mXp=m5,mXn=m6")
